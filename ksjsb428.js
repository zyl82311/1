var ksjsbAdBody = "encData=WlTuzeTU6mGT9525bjJUVnltcwcFQnxjgjAw%2BtDz1mbfo8ZEVHdJY0pKd7s5mx8%2BXMRRi7MCE3BSy1NNxI6bywhQueJl4YV8QDNsCONuMI7m59XX7rycrXz5ZPbObMBFLp23dqIF86Do53AbF3u4Dd2Vsk%2B1BzkhUIjucpA2gZ6g837f5Wz19RFfZ9m0pIuu8qg0EFbwOhyvbnybXJXFHahBNDH%2BfHB3V63CQuUJV6MSpBlFU6%2BDiPwORLmSR81ZkexYHIeTr2ItkalMeSzHjo4hhD00Oa48j%2B%2BFtL0GTpzpMbMuvx2M8j3OEHZHhnmBwZiZ7DMFCH4z95700n4l98a9e0fAsnip7ehHiRCNVs7QSEMghZyZDKgdtcpI3pNIjXNyhvlFcd%2BiWO4BafhSpKXgxR06FhZ8Hpe%2FN8vnOSP0I1F3ZwXHWSa1gMX8GU68VzYGnqZKB7xugzvyKjRmoJhi%2BQBlnOIV9GGpDBWprlbEmer2RVDv4Nldg3r2djzvkKvC5DBBe2nr4XYInYE1Nq1UYypxH%2F6kOm%2BOfAKeXjuSJQO6l1YDiCcjaHga0%2BmIiLrtPFAGo19wi%2FaAmB81pjuijGvBNo5pgJd6C6d0vWlaZBiCOnhx9dyJIp0th2SgYWhnU3aw9j9KKtnocZqfkQNT95mULtWVcNFA%2FDhCCOS%2BcIYkHFst6pYGOI8uQi1rdUG%2BLJTb9aN73a%2B%2FeCr9vMp8CXXjI7XIbVUF7qms1ak5FZe1678EmEKRByRS6fu2YtbgLfR5HFkMjznCMkdSSvLfE2T3zVECB2KKROUwXQaSu%2BNCQB%2BxNVXJOAsNO%2BudtPLOQ58ZwHWOjENerirE3W9XXWjZNa4W&sign=5a54eecde4d4ea610b603763bee1ae0214564c3f1d5f92efab9e4d115c2d7663&sign=3d36df46e61f2d19511cfad2de86f50d"
...
class _0x9d8dda {
  ...
  async ["getUserInfo"]() {
    ...
    t["result"] == 1 ? (this["valid"] = true, this["name"] = t['data']["userData"]["nickname"], this["cashBalance"] = t["data"]["totalCash"], this["coinBalance"] = t["data"]['totalCoin'], this["allCash"] = t['data']["allCash"], console["log"]("账号[" + this['name'] + ']账户余额' + this["cashBalance"] + '元
，' + this["coinBalance"] + "金币，未审核余额" + Math['floor'](parseFloat(this["allCash"]) - parseFloat(this['cashBalance'])) + '元')) : console['log']('账号[' + this["name"] + ']查询账户信息失败：' + t["error_msg"]);
  }
  ...
  async ["getSignInfo"]() {
    ...
    t['result'] == 1 ? (console["log"]("账号[" + this["name"] + ']今天' + (t["data"]['nebulaSignInPopup']["todaySigned"] ? '已' : '未') + '签到'), !t["data"]["nebulaSignInPopup"]["todaySigned"] && (await _0x3de8b8['wait'](200), await this["doSign"](), await _0x3de8b8['wait'](200), await this["setShare"]()))
 : console['log']("账号[" + this["name"] + "]查询签到信息失败：" + t["error_msg"]);
  }
  ...
  async ["doSign"]() {
    ...
    t["result"] == 1 ? (console["log"]('账号[' + this['name'] + "]签到成功：" + t['data']["toast"]), await _0x3de8b8["wait"](200), await this["ksAdParam"](_0x351e94["sign"]), await _0x3de8b8["wait"](200), await this["ksNeoAdParam"](_0x10d9f8['signVideo_168'])) : console["log"]("账号[" + this["name"] + ']签到失败
：' + t["error_msg"]);
  }
  ...
  async ['ksAdParam'](D) {
    ...
    p['result'] == 1 ? p["impAdInfo"] && p["impAdInfo"]["length"] > 0 && p["impAdInfo"][0]["adInfo"] && p['impAdInfo'][0]["adInfo"]["length"] > 0 && p["impAdInfo"][0]['adInfo'][0]["adBaseInfo"] && (await _0x3de8b8["wait"](200), await this["ksAdReward"](p['llsid'], p['impAdInfo'][0]["adInfo"][0]["adB
aseInfo"]["creativeId"], D)) : console["log"]("账号[" + this["name"] + ']获取' + D["name"] + '参数失败：' + p['error_msg']);
  }
  ...
  async ["openBox"](D) {
    ...
    p["result"] == 1 ? D == true ? p["data"]["commonAwardPopup"] && p["data"]['commonAwardPopup']["awardAmount"] ? (console['log']('账号[' + this["name"] + "]开宝箱获得" + p["data"]["commonAwardPopup"]["awardAmount"] + '金币'), await _0x3de8b8["wait"](200), await this['ksAdParam'](_0x351e94["box"])) : consol
e['log']('账号[' + this['name'] + "]开宝箱没有获得金币") : p['data']["openTime"] > -1 ? (console["log"]('账号[' + this["name"] + "]开宝箱冷却时间还有" + Math["floor"](p["data"]["openTime"] / 1000) + '秒'), p["data"]["openTime"] == 0 && (await _0x3de8b8["wait"](200), await this["openBox"](true))) : console["log"]("账号[" + t
his["name"] + ']开宝箱次数已用完') : D == true ? console["log"]('账号[' + this["name"] + "]开宝箱失败：" + p["error_msg"]) : console["log"]("账号[" + this["name"] + "]查询宝箱状态失败：" + p["error_msg"]);
  }
  ...
  async ["ksNeoAdParam"](D) {
    ...
    p["result"] == 1 ? p["impAdInfo"] && p["impAdInfo"]["length"] > 0 && p["impAdInfo"][0]["adInfo"] && p["impAdInfo"][0]['adInfo']["length"] > 0 && p["impAdInfo"][0]["adInfo"][0]["adBaseInfo"] && (await _0x3de8b8["wait"](200), await this["ksNeoAdReward"](p['llsid'], p["impAdInfo"][0]['adInfo'][0]["
adBaseInfo"]["creativeId"], D)) : console['log']("账号[" + this["name"] + "]获取" + D["name"] + "参数失败：" + p["error_msg"]);
  }
  ...
  async ['ksNeoAdReward'](D, j, N) {
    let t = new Date()["getTime"](),
        ...
        n = "bizStr={\"businessId\":" + N["businessId"] + ",\"endTime\":" + t + ",\"extParams\":\"" + N["extParams"] + "\",\"mediaScene\":\"video\",\"neoInfos\":[{\"creativeId\":" + j + ",\"extInfo\":\"\",\"llsid\":" + D + ",\"taskType\":1}],\"pageId\":" + N["pageId"] + ",\"posId\":" + N["posId"] + 
",\"startTime\":" + X + ",\"subPageId\":" + N["subPageId"] + '}',
        z = _0x495d61(L, this['cookie'], n);
  ...
  async ["helpPackage"](D, j) {
    let N = {
      ...
      'body': "{\"fid\":\"895255750\",\"cc\":\"share_wxms\",\"followRefer\":\"151\",\"code\":\"" + D + "\",\"shareMethod\":\"TOKEN\",\"kpn\":\"NEBULA\",\"subBiz\":\"BARGAIN\",\"shareId\":\"16905401129783\",\"shareMode\":\"SYSTEM\",\"noBackNavi\":\"true\",\"originShareId\":\"16905401129783\",\"useMer
chantWeb\":\"1\",\"layoutType\":\"4\",\"shareObjectId\":" + JSON['stringify']("{\"teamId\":\"\",\"packetId\":\"" + j + "\"}") + ",\"shareUrlOpened\":\"0\",\"hyId\":\"bargain\",\"timestamp\":" + +new Date() + ",\"pageCode\":1,\"adamA\":0,\"adamB\":0}",
      'headers': {
        ...
        'Referer': 'https://ug-fission.kuaishou.com/bargain/?fid=895255750&cc=share_wxms&followRefer=151&code=' + D + "&shareMethod=TOKEN&kpn=NEBULA&subBiz=BARGAIN&shareId=16905401129783&shareMode=SYSTEM&noBackNavi=true&originShareId=16905401129783&useMerchantWeb=1&layoutType=4&shareObjectId=%7B%22t
eamId%22%3A%22%22,%22packetId%22%3A%22" + j + "%22%7D&shareUrlOpened=0&hyId=bargain&timestamp=" + +new Date(),
...
async function _0x505e51() {
  ...
  if (j[_0x5bc515]) {
    let N = j[_0x5bc515];
    N["status"] == 0 ? _0x459e63 >= N["version"] ? (_0x2e716e = true, _0x75eec0 = "https://raw.githubusercontent.com/public-Object/cloud-JavaScript/main/ks.json", console['log'](N["msg"][N["status"]]), console["log"](N['updateMsg']), console["log"]("现在运行的脚本版本是：1.07，最新脚本版本：" + N["latestVersion"])) : 
console["log"](N["versionMsg"]) : console["log"](N['msg'][N["status"]]);
  } else {
...
var _0x331719 = {
  ...
  '_utf8_decode': function (D) {
    ...
    while (N < D['length']) {
      t = D["charCodeAt"](N);
      t < 128 ? (j += String["fromCharCode"](t), N++) : t > 191 && t < 224 ? (c2 = D["charCodeAt"](N + 1), j += String["fromCharCode"]((t & 31) << 6 | c2 & 63), N += 2) : (c2 = D["charCodeAt"](N + 1), c3 = D["charCodeAt"](N + 2), j += String['fromCharCode']((t & 15) << 12 | (c2 & 63) << 6 | c3 & 63)
, N += 3);
    }
